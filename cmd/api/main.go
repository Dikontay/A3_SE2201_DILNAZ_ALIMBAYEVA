...
import (
	...
	"github.com/Dikontay/A3_SE2201_DILNAZ_ALIMBAYEVA/internal/data"
	"github.com/Dikontay/A3_SE2201_DILNAZ_ALIMBAYEVA/internal/jsonlog"
	"github.com/Dikontay/A3_SE2201_DILNAZ_ALIMBAYEVA/internal/mailer"
	"github.com/Dikontay/A3_SE2201_DILNAZ_ALIMBAYEVA/internal/vcs"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "b77baad690b3ce", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "c45fc68e6c6ce4", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <tabuldin.a@mail.ru>", "SMTP sender")
